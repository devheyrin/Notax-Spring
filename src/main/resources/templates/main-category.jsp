...
<html>
<head>
    <link rel="stylesheet" href="${path}/resources/css/main-category.css">
    <!-- 슬라이더 !-->
    ...
    <script src="${path}/resources/js/main-category.js"></script>
    <title>대분류 페이지</title>
</head>
...
<br/>
<h1 style="text-align: center">시계/주얼리</h1>
<br/>
<!-- 메인 슬라이드 !-->
<div class="main-container">
    <div class="slider photo-area" id="slider">
        <div><img src="${path}/resources/img/main-category.jpg"></div>
        <div><img src="${path}/resources/img/main-category.jpg"></div>
        <div><img src="${path}/resources/img/main-category.jpg"></div>
    </div>
</div>
