...
<html>
<head>
    <link rel="stylesheet" href="${path}/resources/css/sub-category.css">
    <!--체크박스 !-->
    ...
    <script src="${path}/resources/js/sub-category.js"></script>
    <title>소분류 페이지</title>
</head>
...
<div class="cateHeader-container">
    ...
    <div class="category-name">
        ...
        <img class="arrow-right-icon" src="${path}/resources/img/noun-arrow-right.png"/>
        <div class="form-group nav-item">
            <select class="form-control example2 sub-category" name="example-2">
                <option value="10031760">메탈</option>
                <option value="10031766">가죽</option>
                <option value="10031772">세라믹/티타늄</option>
                <option value="10031778">패브릭/플라스틱</option>
            </select>
        </div>
    </div>
    <!-- 카테고리 이름!-->
    <script type="text/javascript">
        ...
        $('.sub-category').FeastSelect({
            btnText: '메탈', // 선택한 분류 가져와서 지정
            btnClass: 'my-custtom-btn',
            hideOriginal: true
        });
    </script>
